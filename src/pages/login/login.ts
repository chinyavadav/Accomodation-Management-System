...
import { AccessLevelPage } from '../access-level/access-level';
...
export class LoginPage {
	...
	loginFxn(){
		if(this.loginForm.valid){
		  ...
		  loader.present();
		  this.http.post(this.global.serverAddress+"api/login.php", JSON.stringify(this.credentials))
		    .subscribe(data => {
		      ...
		      if(response.response=="success"){
		        ...
		        toast.present();
		        this.navCtrl.setRoot(AccessLevelPage);           
