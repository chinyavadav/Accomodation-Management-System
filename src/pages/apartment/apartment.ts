...
export class ApartmentPage {
	...
	constructor(public http:Http, public loadingCtrl:LoadingController, public toastCtrl:ToastController, public alertCtrl: AlertController ,public global:GlobalProvider, public navCtrl: NavController, public navParams: NavParams) {
	  this.apartment=navParams.get('apartment');
	  this.imgPath=this.global.serverAddress+'/account/avatars/'+this.apartment.fldapartmentid+'.jpg';
  ...
  deletePost(){
      ...
      loader.present();
      let postData={
        "apartmentid":this.apartment.fldapartmentid,
      };
